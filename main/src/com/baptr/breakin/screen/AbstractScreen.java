...
public abstract class AbstractScreen implements Screen {
    ...
    public AbstractScreen( BreakIn game ) {
        this.game = game;
        ...
        preferences = Gdx.app.getPreferences(BreakIn.LOG);
        tmpVec = new Vector3();
    }
    ...
    @Override
    public void show() {
        Gdx.app.log( BreakIn.LOG, "Showing screen: " + getName() );
        Gdx.input.setInputProcessor(input);
    }

    @Override
    public void resize( int width, int height ) {
        Gdx.app.log( BreakIn.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height );
    ...
    public void hide()
    {
        Gdx.app.log( BreakIn.LOG, "Hiding screen: " + getName() );
    }

    @Override
    public void pause()
    {
        Gdx.app.log( BreakIn.LOG, "Pausing screen: " + getName() );
        preferences.flush();
    }
    ...
    public void resume()
    {
        Gdx.app.log( BreakIn.LOG, "Resuming screen: " + getName() );
    }

    @Override
    public void dispose()
    {
        Gdx.app.log( BreakIn.LOG, "Disposing screen: " + getName() );
