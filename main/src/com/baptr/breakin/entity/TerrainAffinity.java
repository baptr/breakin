package com.baptr.breakin.entity;
...
import com.baptr.breakin.entity.Entity.TileType;
        ...
        try {
            ...
            for(String unitName : cfg.keys()) {
                ...
                try {
                    ...
                    Gdx.app.error(BreakIn.LOG, "Unrecognized UnitType in " +
